// Created by Microsoft (R) C/C++ Compiler Version 14.51.36252.0 (57e445a7).
//
// C:\Users\s4mp0l\AppData\Local\Temp\claude\C--Development-CETP-sKiller-sKiller\147f8f1b-e6f3-4a57-bbbe-e382ecb72a75\scratchpad\mscorlib.tlh
//
// C++ source equivalent of type library C:\Windows\Microsoft.NET\Framework64\v4.0.30319\mscorlib.tlb
...
enum AppDomainManagerInitializationOptions : int;
...
enum EnvironmentVariableTarget : int;
...
enum DebuggerBrowsableState : int;
...
enum UltimateResourceFallbackLocation : int;
struct /* coclass */ Registry;
enum RegistryHive : int;
struct /* coclass */ RegistryKey;
enum RegistryValueKind : int;
...
enum ApplicationVersionMatch : int;
...
enum TrustManagerUIContext : int;
...
enum PolicyStatementAttribute : int;
...
enum TokenAccessLevels : int;
enum WindowsAccountType : int;
enum TokenImpersonationLevel : int;
struct /* coclass */ WindowsIdentity;
struct /* coclass */ WindowsImpersonationContext;
enum WindowsBuiltInRole : int;
...
enum AssemblyRegistrationFlags : int;
struct __declspec(uuid("ccbd682c-73a5-4568-b8b0-c7007e11aba2"))
    /* dual interface */ IRegistrationServices;
enum TypeLibImporterFlags : int;
enum TypeLibExporterFlags : int;
enum ImporterEventKind : int;
enum ExporterEventKind : int;
...
enum CompilationRelaxations : int;
...
enum MethodImplOptions : int;
enum MethodCodeType : int;
...
enum EnvironmentPermissionAccess : int;
...
enum UIPermissionWindow : int;
enum UIPermissionClipboard : int;
...
enum KeyContainerPermissionFlags : int;
...
enum RegistryPermissionAccess : int;
...
enum HostSecurityManagerOptions : int;
...
enum PolicyLevelType : int;
struct /* coclass */ SecurityManager;
enum SecurityZone : int;
...
enum FormatterTypeStyle : int;
enum FormatterAssemblyStyle : int;
enum TypeFilterLevel : int;
...
enum PEFileKinds : int;
struct /* coclass */ OpCodes;
struct OpCode;
enum OpCodeType : int;
enum StackBehaviour : int;
...
struct AssemblyHash;
enum AssemblyHashAlgorithm : int;
enum AssemblyVersionCompatibility : int;
enum CipherMode : int;
...
enum X509ContentType : int;
enum X509KeyStorageFlags : int;
struct /* coclass */ X509Certificate;
enum SpecialFolder : int;
enum DebuggingModes : int;
...
enum __declspec(uuid("148540d3-e67f-36dc-a55d-2c8dec53b9d3"))
    AppDomainManagerInitializationOptions : int
{
...
enum __declspec(uuid("6bd98650-5ae6-3f03-b6cf-1463bbd45e6d"))
    ExceptionHandlingClauseOptions : int
{
...
enum __declspec(uuid("2173568c-6edc-392b-880a-cc158d7e2bda"))
    UltimateResourceFallbackLocation : int
{
...
enum __declspec(uuid("b3b46869-c190-3199-96da-4006e2ac6e72"))
    RegistryHive : int
{
    RegistryHive_ClassesRoot = static_cast<int>(0x80000000),
...
{
    FileOptions_None = 0,
    FileOptions_WriteThrough = static_cast<int>(0x80000000),
...
enum __declspec(uuid("ec73fceb-1aea-3a57-b953-21368e992507"))
    EnvironmentPermissionAccess : int
{
...
enum __declspec(uuid("0df04a9b-dddc-3777-a6b1-9604b5ced191"))
    FileDialogPermissionAccess : int
{
...
enum __declspec(uuid("0d6e31df-3a76-3054-a8eb-150e92300f89"))
    IsolatedStorageContainment : int
{
...
enum __declspec(uuid("742bdc16-f04e-3e0e-8ff1-e3250940b5bf"))
    KeyContainerPermissionFlags : int
{
...
enum __declspec(uuid("51e1b3ca-d3cb-39bf-a016-6199569e74b2"))
    HostSecurityManagerOptions : int
{
...
enum __declspec(uuid("e3dc8079-43bc-3e70-b291-1591cc9e451d"))
    AssemblyVersionCompatibility : int
{
